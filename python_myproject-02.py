# project 2 Metro duraklar arası süre hesaplama  # "durak adı yanlış girildiğinde hata verme sorunu"
...
kadıköy_yönü = {"Kadıköy" : 1, "Ayrılık Çeşmesi" : 2, "Acıbadem" : 3, "Ünalan" : 4, "Uzunçayır" : 5, "Göztepe" : 6, 
           ...
           "Yakacık Adnan Kahveci" : 18, "Pendik" : 19, "Tavşantepe" : 20}  # kadıköy yönüne giderken durak sıraları
tavşantepe_yönü = {"Kadıköy" : 20, "Ayrılık Çeşmesi" : 19, "Acıbadem" : 18, "Ünalan" : 17, "Uzunçayır" : 16, "Göztepe" : 15, 
           ...
           "Yakacık Adnan Kahveci" : 3, "Pendik" : 2, "Tavşantepe" : 1}  # tavşantepe yönüne giderken durak sıraları
...
while True:
  ...
  if yön == "Kadıköy":  # girilen yön kadıköy ise aşağıyı çalıştır
    durak_sayısı = (int(kadıköy_yönü[mevcut] - kadıköy_yönü[hedef]))  # girilen yön durak numarasından hedefdeki durak numarası çıkarılır
    ...
    print(f"Ortalama {sonuç} dakika sonra {hedef} durağına varacaksınız. İyi yolculuklar dileriz..")
    break  # tüm bilgiler doğru girilir ise sonucu verip programı durdur, değil ise uyarı verip başa sar
  else:
